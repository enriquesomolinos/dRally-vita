...
void dRally_Keyboard_init(void){
    ...
    dR_Scancodes[JOY_BTN_TRIANGLE] = DR_SCAN_SPACE; //horn
    dR_Scancodes[JOY_BTN_CIRCLE] = DR_SCAN_DELETE;
    dR_Scancodes[JOY_BTN_CROSS] = DR_SCAN_KP_ENTER; //accept
    dR_Scancodes[JOY_BTN_SQUARE] = DR_SCAN_LALT; //mines
    dR_Scancodes[JOY_BTN_LTRIGGER] = DR_SCAN_LCTRL; //shot
    dR_Scancodes[JOY_BTN_RTRIGGER] = DR_SCAN_LSHIFT; //turbo

    dR_Scancodes[JOY_BTN_START] = DR_SCAN_DELETE;

    dR_Scancodes[JOY_BTN_SELECT] = DR_SCAN_ESCAPE;
    dR_Scancodes[JOY_BTN_DOWN] = DR_SCAN_DOWN;
    dR_Scancodes[JOY_BTN_LEFT] = DR_SCAN_LEFT;
    dR_Scancodes[JOY_BTN_UP] = DR_SCAN_UP;
    dR_Scancodes[JOY_BTN_RIGHT] = DR_SCAN_RIGHT;
