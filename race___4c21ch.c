	...
	while(++n < (int)NUM_OF_CARS){
		...
		if((n != MY_CAR_IDX)||(D(___243ce0h) != 0)){
			...
			if((int)D(___1de580h+0x94*n+0x18) > 0){
				...
				dw0 = dw0* CIRCUIT_VAI_ZONES +s_35e[MY_CAR_IDX].__0;
				dw1 = s_35e[n].Lap;
				dw1 = dw1* CIRCUIT_VAI_ZONES +s_35e[n].__0;
				dw0 -= 1;
				if(dw1 == dw0) diff_f = 1.0f+___3f6ech[2*i];
				dw1 = s_35e[MY_CAR_IDX].Lap;
				dw1 = dw1* CIRCUIT_VAI_ZONES +s_35e[MY_CAR_IDX].__0;
				dw0 = s_35e[n].Lap;
				dw0 = dw0* CIRCUIT_VAI_ZONES +s_35e[n].__0;
				dw1 -= 2;
